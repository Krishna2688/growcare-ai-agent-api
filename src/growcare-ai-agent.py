...
classification_prompt = f"""You are classifying whether a user role content is related to general medical topics such as medical or healthcare. 
                            Specifically, determine if the content related to:
                            - top medical professionals (including location-specific queries) (e.g., cardiologists, nephrologists, osteo)
                            - Medical tourism & Medical travel (e.g., visas, destination, logistics)
                            ...
                            - any general medical or healthcare-related term or concept (e.g., 'What is medicine?') 
                            - {growcare_data}           
                        
                        Examples of relevant content include:
                            - "Who are the top 3 cardiologists from Kerala?"
                            - "What is the average wait time for surgery in USA?"
                            - "What types of treatments are available for diabetes?"
                            - "Summarize my blood test report"
                            - "What are abonormilities in my report?"
                            - "How can I contact Growcare"
                            - "Give me the steps to avail growcare services"      
...
#                         Classify the content from user role as either 'Relevant' or 'Not Relevant' based on whether it pertains
#                         to medical topics such as health care, medical tourism, medical treatments, medical professionals (e.g., doctors, specialists, surgeons), medical reports, or {growcare_data}.
#                         This includes queries about specific medical professionals like 'cardiologists,' 'surgeons,' or other specialists.
#                         If the content is related to any of these topics, classify as 'Relevant'.
#                         If the content is related to any other topics, classify as 'Not Relevant'.
#                         """
